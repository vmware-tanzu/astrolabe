...
func (o *DeleteProtectedEntityURL) WithBasePath(bp string) *DeleteProtectedEntityURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteProtectedEntityURL) Build() (*url.URL, error) {
	...
	if protectedEntityID != "" {
		...
		return nil, errors.New("protectedEntityId is required on DeleteProtectedEntityURL")
	}
	...
	if service != "" {
		...
		return nil, errors.New("service is required on DeleteProtectedEntityURL")
	}
...
func (o *DeleteProtectedEntityURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteProtectedEntityURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteProtectedEntityURL")
	}

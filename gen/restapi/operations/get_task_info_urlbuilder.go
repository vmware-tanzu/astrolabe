...
func (o *GetTaskInfoURL) Build() (*url.URL, error) {
	...
	if taskID != "" {
		...
		return nil, errors.New("taskId is required on GetTaskInfoURL")
	}
...
func (o *GetTaskInfoURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTaskInfoURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTaskInfoURL")
	}

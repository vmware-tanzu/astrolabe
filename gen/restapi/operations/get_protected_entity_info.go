...
func (fn GetProtectedEntityInfoHandlerFunc) Handle(params GetProtectedEntityInfoParams) middleware.Responder {
	return fn(params)
}
...
func NewGetProtectedEntityInfo(ctx *middleware.Context, handler GetProtectedEntityInfoHandler) *GetProtectedEntityInfo {
	return &GetProtectedEntityInfo{Context: ctx, Handler: handler}
}
...
func (o *GetProtectedEntityInfo) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetProtectedEntityInfoParams()

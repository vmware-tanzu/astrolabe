...
func (o *CopyProtectedEntityURL) WithBasePath(bp string) *CopyProtectedEntityURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CopyProtectedEntityURL) Build() (*url.URL, error) {
	...
	if service != "" {
		...
		return nil, errors.New("service is required on CopyProtectedEntityURL")
	}
...
func (o *CopyProtectedEntityURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CopyProtectedEntityURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CopyProtectedEntityURL")
	}

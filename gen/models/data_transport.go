...
// ContextValidate validates this data transport based on context it is used
func (m *DataTransport) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

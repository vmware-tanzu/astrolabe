...
// ContextValidate validate this operation param list based on the context it is used
func (m OperationParamList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error

...
// ContextValidate validate this operation p e param list based on the context it is used
func (m OperationPEParamList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
